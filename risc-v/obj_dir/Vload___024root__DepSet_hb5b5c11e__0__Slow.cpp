...
VL_ATTR_COLD void Vload___024root___eval_initial__TOP(Vload___024root* vlSelf) {
    ...
    __Vtemp_1[2U] = 0x2e70726fU;
    __Vtemp_1[3U] = 0x6c6f6164U;
    VL_READMEM_N(true, 32, 1024, 0, VL_CVT_PACK_STR_NW(4, __Vtemp_1)
                 ,  &(vlSelf->load__DOT__imem), 0, ~0ULL);
    ...
    while (VL_GTS_III(32, 0x400U, load__DOT__i)) {
        vlSelf->load__DOT__dmem[(0x3ffU & load__DOT__i)] = 0U;
...
VL_ATTR_COLD void Vload___024root___ctor_var_reset(Vload___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 1024; ++__Vi0) {
        vlSelf->load__DOT__imem[__Vi0] = VL_RAND_RESET_I(32);
    }
    for (int __Vi0 = 0; __Vi0 < 1024; ++__Vi0) {
        vlSelf->load__DOT__dmem[__Vi0] = VL_RAND_RESET_I(32);
    }
    vlSelf->load__DOT__imem_addr = VL_RAND_RESET_I(10);
    vlSelf->load__DOT__imem_rdata = VL_RAND_RESET_I(32);
    vlSelf->load__DOT__dmem_addr = VL_RAND_RESET_I(10);
    vlSelf->load__DOT__dmem_we = VL_RAND_RESET_I(1);
    vlSelf->load__DOT__dmem_wdata = VL_RAND_RESET_I(32);
    vlSelf->load__DOT__dmem_rdata = VL_RAND_RESET_I(32);
    vlSelf->load__DOT__sw_addr = VL_RAND_RESET_I(32);
    vlSelf->load__DOT__lw_addr = VL_RAND_RESET_I(32);
    ...
    vlSelf->__Vdlyvdim0__load__DOT__dmem__v0 = 0;
    vlSelf->__Vdlyvval__load__DOT__dmem__v0 = VL_RAND_RESET_I(32);
    vlSelf->__Vdlyvset__load__DOT__dmem__v0 = 0;
    ...
    vlSelf->__Vdly__load__DOT__dmem_addr = VL_RAND_RESET_I(10);
    vlSelf->__Vdlyvset__load__DOT__registers__v1 = 0;
    vlSelf->__Vdlyvset__load__DOT__registers__v2 = 0;
    vlSelf->__Vdly__load__DOT__imem_addr = VL_RAND_RESET_I(10);
